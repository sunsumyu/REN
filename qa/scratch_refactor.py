...
"""
    ...
    pattern = re.compile(r"(\s+purified_diff_logs = \[\]\s+audit_events = \[\]\s+force_repurify = .*?)\s+purify_counter = 0", re.DOTALL)
...
"""
    ...
    with open('scripts/medicalqa_purifier.py', 'w', encoding='utf-8') as f:
        f.write(content)
