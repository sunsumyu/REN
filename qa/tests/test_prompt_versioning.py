...
db_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "prompts.db")
import sqlite3
try:
...
# Add current directory and parent directory to path to ensure we can import prompts
